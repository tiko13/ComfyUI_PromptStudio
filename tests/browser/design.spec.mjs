...
try {
 ...
 const studio = videoEnabled ? 'video' : 'image';
 ...
 await page.screenshot({path:resolve(root,`test-results/browser/${studio}-design-zoom200.png`)});
