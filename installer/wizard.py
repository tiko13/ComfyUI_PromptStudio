...
<div class="shell">
  ...
  <main>
    <div class="content">
      ...
      <section class="page" data-page="3"><div class="eyebrow">Local language model</div><h1>Connect the prompt brain.</h1><p class="lead">The managed Ollama option is terminal-free and unloads the LLM after every request, freeing a single GPU before ComfyUI starts generating.</p><div id="llms" class="grid"></div><div id="ollama-options" class="hidden"><h2>Ollama model</h2><div id="ollama-models" class="stack"></div><div id="ollama-placement"></div></div><div id="kobold-options" class="hidden"><h2>KoboldCpp endpoint</h2><div class="form-row"><input id="kobold-url" value="http://127.0.0.1:5001"/></div><p class="lead" style="margin-top:10px">Keep KoboldCpp running with your chosen GGUF model. The wizard will configure Prompt Studio to use this endpoint.</p></div></section>
